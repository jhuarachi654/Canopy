  ...
  return (
    <div className="min-h-screen">
      <div className="px-4 pt-4 pb-6 overflow-y-auto" style={{ maxHeight: '100vh' }}>
        ...
        {/* Profile header */}
        <div className="mb-4 rounded-3xl border border-[var(--border-soft)] bg-white p-6 shadow-sm backdrop-blur-sm">
        ...
        {/* Settings rows */}
        <div className="mb-4 overflow-hidden rounded-3xl border border-[var(--border-soft)] bg-white shadow-sm backdrop-blur-sm">
          {[
        ...
        {/* Focus mode control */}
        <div className="mb-4 rounded-3xl border border-[var(--border-soft)] bg-white p-5 shadow-sm backdrop-blur-sm">
