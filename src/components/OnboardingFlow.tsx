  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex h-full w-full max-w-[min(393px,100%)] flex-1 flex-col px-[var(--space-6)] sm:px-[var(--space-10)]">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-[var(--space-6)] sm:px-[var(--space-10)] transition-all duration-300 ease-out" style={{ paddingBottom: `${Math.max(32, keyboardHeight + 16)}px` }}>
          {/* Step 1: Name */}
          {currentStep === 0 && (
            <button
              type="button"
